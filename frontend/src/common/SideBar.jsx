    ...
    <>
      ...
      >
        ...
        <ListGroup variant="flush">
          <Link to="/app/category-home" style={{ textDecoration: "none" }}>
            <ListGroup.Item action className="border-0 mb-0">
              <img
                src={categories}
                className="me-2"
                width="22px"
          ...
          <ListGroup.Item action className="border-0 mb-0">
            <FaBox className="ms-1 me-2" /> {t("ADDNEWINVENTORY")}
          </ListGroup.Item>
          <Link to="/app/supplier-home" style={{ textDecoration: "none" }}>
            <ListGroup.Item action className="border-0 mb-0">
              <FaTruck className="ms-1 me-3" />
              {t("ADDSUPPLIER")}
            </ListGroup.Item>
          </Link>
          <ListGroup.Item action className="border-0 mb-0">
            <FaFileExport className="ms-1 me-2" /> {t("EXPORTREPORT")}
          </ListGroup.Item>
        </ListGroup>
